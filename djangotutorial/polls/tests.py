...
class ChoiceModelTests(TestCase):
    def test_choice_str_method(self):
        ...
        choice = Choice(question=question, choice_text="Test choice", votes=0)
...
class QuestionResultsViewTests(TestCase):
    def test_results_view_with_past_question(self):
        """
        The results view displays voting results for a past question.
        """
        question = create_question(question_text="Past Question.", days=-5)
        choice1 = Choice.objects.create(
            question=question, choice_text="Choice 1", votes=0
        )
        choice2 = Choice.objects.create(
            question=question, choice_text="Choice 2", votes=0
        )
...
class VotingTests(TestCase):
    def test_vote_increments_choice_votes(self):
        """
        Voting on a choice increments its vote count.
        """
    ...
    def test_vote_without_choice_shows_error(self):
        """
        Voting without selecting a choice shows an error message.
        """
        question = create_question(question_text="Test question?", days=-1)
    ...
    def test_vote_redirects_to_results(self):
        """
        After voting, user is redirected to the results page.
        """
        question = create_question(question_text="Test question?", days=-1)
        choice = Choice.objects.create(
            question=question, choice_text="Test choice", votes=0
